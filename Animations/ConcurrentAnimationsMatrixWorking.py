...
# Make the Worm animations an list pairs (animation instances, fps)
wormlist = [(Worm(ledslaves[i], *wd[0]), wd[2]) for i, wd in enumerate(wormdatalist)]
...
wave = WA.Wave(ledslavew, (255, 255, 255), 1)
wormlist.append((wave, 30))
...
if __name__ == '__main__':  
    ...
    masteranimation = MasterAnimation(ledmaster, wormlist, runtime=1)
